from Destroyer import ALIVE_NAME
...
pm_caption += "➥ **Repo** :  [HERE](https://github.com/rahulchoudhary17/DESTROYER-USERBOT)\n"
pm_caption += "[Support Channel](https://t.me/DESTROYER_USERBOT)"
