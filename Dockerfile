...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Rahulchoudhary17/DESTROYER-USERBOT/master/start.py
RUN wget https://raw.githubusercontent.com/Rahulchoudhary17/DESTROYER-USERBOT/master/requirements.txt
#Start Fumkin
